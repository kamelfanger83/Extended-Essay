...
plots = [ #dependent, axis name, split, infile, title, outfile
    ["predation rate", "Predation rate", "predator scared frames", "scared_frames.csv", "Density dependence of Predation Rate", "single_PR.png"],
    ["predator population size", "Numerical response", "predator scared frames", "scared_frames.csv", "Density dependence of Numerical Response", "single_NR.png"],
    ["average prey eaten per predator", "Functional response", "predator scared frames", "scared_frames.csv", "Density dependence of Functional Response", "single_FR.png"],
]
"""
